...
!(function ($) {
  ...
  (SEMICOLON.initialize = {
      ...
      $verticalMiddleEl.length > 0 &&
        $verticalMiddleEl.each(function () {
          ...
          e.parents("#slider").length > 0 &&
            ...
            e.parents(".full-screen").length &&
            !e.parents(".force-full-screen").length
    ...
    fullScreen: function () {
      $fullScreenEl.length > 0 &&
        $fullScreenEl.each(function () {
          ...
          e.parents(".full-screen").length > 0 &&
            (t = e.parents(".full-screen").height()),
            ($body.hasClass("device-sm") || $body.hasClass("device-xs")) &&
              (e.hasClass("force-full-screen") || (t = "auto")),
            a && (t -= Number(a)),
            e.css("height", t),
            "slider" != e.attr("id") ||
              e.hasClass("canvas-slider-grid") ||
              (e.has(".swiper-slide") &&
                e.find(".swiper-slide").css("height", t));
        });
    },
    ...
    modal: function () {
      ...
      e.length > 0 &&
        e.each(function () {
          ...
          if (
            (e.hasClass("enable-cookie") || Cookies.remove(a),
    ...
    pageTransition: function () {
      ...
      e || (e = "fadeIn"),
        ...
        $wrapper.animsition({
          ...
          loadingInner:
            l +
            '<a href="?transition=disable" class="button button-small button-rounded disable-pagetransition">Saltar</a>',
          timeout: s,
          timeoutCountdown: o,
          onLoadEvent: !0,
    ...
    topScrollOffset: function () {
      ...
      return (
        ...
        SEMICOLON.isMobile.any()
          ? (e = 40)
          : ((e = $header.hasClass("sticky-header")
              ...
              : 184),
            $pagemenu.length ||
              (e = $header.hasClass("sticky-header") ? 100 : 140)),
        e
      );
    },
      ...
      return (
        e.hasClass("portfolio-full")
          ? ((t = e.hasClass("portfolio-3")
              ...
              ? 6
              : 4),
            !$body.hasClass("device-md") || (4 != t && 5 != t && 6 != t)
              ? !$body.hasClass("device-sm") ||
                (3 != t && 4 != t && 5 != t && 6 != t)
                ? $body.hasClass("device-xs") && (t = 1)
                : (t = 2)
              : (t = 3))
      ...
      e.length > 0 &&
        e.each(function () {
          var e = $(this),
            ...
            a =
              e.attr("data-class-sm") +
              " " +
              e.attr("data-class-md") +
              " " +
              e.attr("data-class-lg") +
              " " +
              e.attr("data-class-xl");
    ...
    (SEMICOLON.header = {
      ...
      superfish: function () {
        if ($body.hasClass("device-xl") || $body.hasClass("device-lg")) {
          ...
          $(
            ...
            onShow: function () {
              var e = $(this);
              e.find(".owl-carousel.customjs").length > 0 &&
                (e.find(".owl-carousel").removeClass("customjs"),
                SEMICOLON.widget.carousel()),
                e.find(".grid-container").length > 0 &&
                  e.find(".grid-container").isotope("layout");
            },
          }),
        ...
        $("#primary-menu ul li:has(ul)").addClass("sub-menu"),
          ...
          ($body.hasClass("device-xl") || $body.hasClass("device-lg")) &&
            ($("#primary-menu.sub-title > ul > li").hover(
              ...
              function () {
                $(this).prev().css({
                  backgroundImage: 'url("images/icons/menu-divider.webp")',
                });
              }
            ),
      ...
      fullWidthMenu: function () {
        $body.hasClass("stretched")
          ? ($header.find(".container-fullwidth").length > 0 &&
      ...
      topsearch: function () {
        $(document).on("click", function (e) {
          $(e.target).closest("#top-search").length ||
            ...
            $(e.target).closest("#top-cart").length ||
              $topCart.toggleClass("top-cart-open", !1),
            $(e.target).closest("#page-menu").length ||
              $pagemenu.toggleClass("pagemenu-active", !1),
            ...
            $(e.target).closest("#primary-menu").length ||
              $("#primary-menu.on-click > ul")
                .find(".d-block")
                .removeClass("d-block"),
            $(e.target).closest("#primary-menu.mobile-menu-off-canvas > ul")
              .length ||
                      ...
                      $(".swiper-slide-active [data-animate]").each(
                        function () {
                          var e = $(this),
                            ...
                            a = 0;
                          if (
                            ((a = t ? Number(t) + 750 : 750),
                            !e.hasClass("animated"))
                          ) {
                            e.addClass("not-animated");
                            var i = e.attr("data-animate");
                            setTimeout(function () {
                              e.removeClass("not-animated").addClass(
                                i + " animated"
                              );
                            }, a);
                          }
                  ...
                  transitionEnd: function (e) {
                    element.find(".swiper-slide").each(function () {
                      ...
                      e.find("video").length > 0 &&
                        ...
                        e.find(".yt-bg-player.mb_YTPlayer:not(.customjs)")
                          .length > 0 &&
                          e
                      ...
                      element
                        ...
                        .each(function () {
                          var e = $(this);
                          e.find("video").length > 0 &&
                            0 != e.find("video").get(0).currentTime &&
        ...
        e.length > 0 &&
          e.each(function () {
            ...
            if (e.find(".portfolio-desc").length > 0) {
              ...
              if (
                e.find("a.left-icon").length > 0 ||
                e.find("a.right-icon").length > 0 ||
                e.find("a.center-icon").length > 0
              )
                var i = 60;
              else i = 0;
              var s = (t - a - i) / 2;
        ...
        $(".portfolio-ajax .portfolio-item a.center-icon")
          ...
          .on("click", function (e) {
            ...
            $(this).parents(".portfolio-item").hasClass("portfolio-active") ||
              SEMICOLON.portfolio.loadItem(t, prevPostPortId),
              e.preventDefault();
          });
      },
    ...
    (SEMICOLON.widget = {
        ...
        e.length > 0 &&
          e.each(function () {
            ...
            "open" != e.attr("data-state")
              ? e.children(".togglec").hide()
              : e.children(".togglet").addClass("toggleta"),
              e
                .children(".togglet")
                .off("click")
                .on("click", function () {
      ...
      notifications: function (e) {
        ...
        return (
          (a = a
            ? "toast-" + t.attr("data-notify-position")
            : "toast-top-right"),
                  ...
                  $(e).ajaxSubmit({
                    ...
                    success: function (l) {
                      if (
                        ("button" == i
                          ? n.html(r)
                          : $(e).find(".form-process").fadeOut(),
                        "error" != l.alert && o)
                      )
                        return window.location.replace(o), !0;
                      if ("inline" == a) {
                      ...
                      if ("error" != l.alert) {
                        ...
                        $(e).trigger("formSubmitError"),
                          $body
                            .removeClass(t + "-success")
                            .addClass(t + "-error");
                      t &&
                        $body
                          .removeClass(t + "-processing")
                          .addClass(t + "-complete"),
                        $(e).find(".g-recaptcha").children("div").length > 0 &&
                          grecaptcha.reset();
                    },
                  });
              },
              ...
              $(e).ajaxSubmit({
                ...
                success: function (r) {
                  if (
                    ...
                    return window.location.replace(s), !0;
                  if ("inline" == t) {
                    ...
                    i
                      .attr("data-notify-type", r.alert)
                      .attr("data-notify-msg", r.message)
                      .html(""),
    ...
    (SEMICOLON.documentOnReady = {
      init: function () {
        SEMICOLON.initialize.init(),
          ...
          ($slider.length > 0 || $sliderElement.length > 0) &&
  ...
  jQuery.get(
    "http://themes.semicolonweb.com/html/canvas/switcher-html.html",
    function (e) {
